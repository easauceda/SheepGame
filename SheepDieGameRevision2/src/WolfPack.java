...
public class WolfPack extends JFrame implements ActionListener {
	...
	public WolfPack(String userName, String server, int port) {
	...
	public static void main(String[] args) {
		...
		WolfPack client = new WolfPack(args[0], args[1],
